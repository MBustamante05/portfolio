...
function ProjectCard({ id, name, description, image, github, live }: Props) {
  ...
  return (
    <div className="col-span-1 flex flex-col border border-[#333] p-3 rounded-sm cursor-pointer hover:bg-[#222] transition duration-300 ease-in-out" onClick={redirectPage}>
      ...
      <div className="flex items-center justify-between mt-5">
        <div className="flex items-center gap-1 hover:text-primary cursor-pointer">
          <a href={live}>Live</a>
          <MoveUpRight size={20} strokeWidth={1.75} absoluteStrokeWidth />
        </div>
